...
const Login = () => {
    ...
    return (
        <div className='login-bg p-2' xs={1} md={3}>
            <Card style={{ width: '23rem' }} xs={1} md={3} className="login-page mb-5 mt-4">
                <Card.Body>
                    <Card.Text >
                        <h2 className="text-center mb-2" data-aos="fade-right"
                            data-aos-offset="300"
                            data-aos-easing="ease-in-sine" data-aos-duration="3000">Please Log in</h2>
                        <form onSubmit={handleSubmit} className="form-container">
                            ...
                            <input
                                type="submit"
                                value="Login"
                                className="btn btn-all mt-3" data-aos="fade-left"
                                data-aos-anchor="#example-anchor"
                                data-aos-offset="500"
